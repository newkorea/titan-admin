...
class TblDeviceInfo(models.Model):
    ...
    device_city = models.CharField(max_length=200, blank=True, null=True)
    device_isp = models.CharField(max_length=200, blank=True, null=True)
    session_key = models.CharField(max_length=200, blank=True, null=True)
    api_url = models.CharField(max_length=200)
    load_balancer = models.CharField(max_length=200, blank=True, null=True)
...
class TblUser(models.Model):
    ...
    v2ray_uuid = models.CharField(max_length=36, blank=True, null=True)
    v2ray_deployed = models.IntegerField(default=0)
