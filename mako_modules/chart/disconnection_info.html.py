...
_magic_number = 10
_modified_time = 1750844408.458288
_enable_loop = True
_template_filename = '/www/wwwroot/tiadmintansk1.titanvpn.kr/backend/templates/chart/disconnection_info.html'
_template_uri = 'chart/disconnection_info.html'
...
def render_subtitle(context,**pageargs):
    ...
    try:
        ...
        __M_writer = context.writer()
        __M_writer('You can see user force disconnect logs')
        return ''
    finally:
        context.caller_stack._pop_frame()
...
def render_js(context,**pageargs):
    ...
    try:
        ...
        __M_writer = context.writer()
        __M_writer('\r\n<script src="/static/chart/js/disconnection_info.js"></script>\r\n')
        return ''
    finally:
        context.caller_stack._pop_frame()
...
"""
__M_BEGIN_METADATA
{"filename": "/www/wwwroot/tiadmintansk1.titanvpn.kr/backend/templates/chart/disconnection_info.html", "uri": "chart/disconnection_info.html", "source_encoding": "utf-8", "line_map": {"27": 0, "42": 1, "47": 4, "52": 6, "57": 7, "62": 77, "67": 81, "73": 3, "79": 3, "85": 6, "91": 6, "97": 7, "103": 7, "109": 9, "115": 9, "121": 79, "127": 79, "133": 127}}
__M_END_METADATA
"""
