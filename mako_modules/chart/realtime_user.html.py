...
_magic_number = 10
_modified_time = 1762037804.090303
_enable_loop = True
_template_filename = '/home/ubuntu/project/titan-admin/backend/templates/chart/realtime_user.html'
_template_uri = 'chart/realtime_user.html'
...
def render_subtitle(context,**pageargs):
    ...
    try:
        ...
        __M_writer = context.writer()
        __M_writer('TITAN VPN을 사용하는 사용자들을 실시간으로 보여줍니다')
        return ''
    finally:
        context.caller_stack._pop_frame()
...
def render_js(context,**pageargs):
    ...
    try:
        ...
        __M_writer = context.writer()
        __M_writer('\n<script src="/static/chart/js/realtime_user.js"></script>\n')
        return ''
    finally:
        context.caller_stack._pop_frame()
...
"""
__M_BEGIN_METADATA
{"filename": "/home/ubuntu/project/titan-admin/backend/templates/chart/realtime_user.html", "uri": "chart/realtime_user.html", "source_encoding": "utf-8", "line_map": {"27": 0, "42": 1, "47": 4, "52": 6, "57": 7, "62": 29, "67": 33, "73": 3, "79": 3, "85": 6, "91": 6, "97": 7, "103": 7, "109": 9, "115": 9, "121": 31, "127": 31, "133": 127}}
__M_END_METADATA
"""
