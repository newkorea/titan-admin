...
function click_search(){
    var url = '/api/v1/read/realtime_user2'
    ...
    .done(function( data ) {
        ...
        $.each(result, function( index, value ) {
            var html =  ''+
                ...
                '<td><button onclick="update_db(\''+ value.sessionid +'\')" class="btn btn-outline b-danger text-danger">DB</button>' +
                '     <button onclick="disconnect(\''+value.sessionid+'\')" class="btn btn-outline b-danger text-danger ml-1">FORCE</button></td>'+
                '</tr>'
...
function click_search2(){
    var url = '/api/v1/read/realtime_user3'
    csrf_token = $('#csrf_token').html();
    var param = {
        csrfmiddlewaretoken: csrf_token
    }
