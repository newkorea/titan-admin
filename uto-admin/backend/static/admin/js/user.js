...
function show_user_diagnosis(user_id) {
    ...
    $.post("/api/v1/read/user_diagnosis", {
        ...
        html += '<div style="flex:1;min-width:280px;background:#f8f9fa;border-radius:8px;padding:14px;border:1px solid #e9ecef;">';
        html += '<div style="font-weight:700;font-size:14px;margin-bottom:8px;color:#495057;"><i class="fa fa-signal"></i> 현재 상태</div>';
        ...
        if (activeCount > 0) {
            d.active_sessions.forEach(function(s) {
                ...
                html += '<div style="background:#fff;border-radius:6px;padding:8px 10px;margin-top:6px;border:1px solid #dee2e6;font-size:11px;">';
