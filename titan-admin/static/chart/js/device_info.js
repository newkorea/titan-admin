...
var datatable = $('#device-inform').DataTable({
    ...
    ajax: {
        ...
        data: {
            ...
            app_version: function() { return $('#filter_app_version').val() },
            device_ip: function() { return $('#filter_device_ip').val() },
            device_country: function() { return $('#filter_country').val() },
            device_city: function() { return $('#filter_city').val() },
            device_type: function() { return $('#filter_device').val() },
            api_url: function() { return $('#filter_api').val() },
            load_balancer: function() { return $('#filter_load').val() },
    ...
    columnDefs: [
        ...
        },
        {
            ...
            visible: true,
            render: function (data) {
                var app_version = $('#filter_app_version').val();
                if(data == "None" && app_version != "")
                    return app_version;
                else
                    return data;
            }
        },
        {
            ...
            visible: true,
            render: function (data) {
                var device_os = $('#filter_device').val();
                if(data == "None" && device_os != "All")
                    return device_os;
                else
                    return data;
            }
